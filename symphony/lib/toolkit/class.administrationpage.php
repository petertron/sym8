                ...
                foreach ($extension_navigation as $item) {
                    ...
                    switch ($type) {
                        case Extension::NAV_GROUP:
                            // An extansion should give the `index` as an integer.
                            // If the `index` is missing, it becomes the lowest level (0).
                            // Changed by tiloschroeder.de
                            if ( isset($item['index']) ) {
                                $index = General::array_find_available_index($nav, $item['index']);
                            } else {
                                $index = 0;
                            }
